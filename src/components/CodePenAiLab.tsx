  ...
  return (
    <main className="fixed inset-0 z-0 flex h-[100dvh] w-full flex-col overflow-hidden overscroll-none bg-slate-50/90 font-sans text-slate-800">
      ...
      <header className="relative z-10 flex shrink-0 items-center justify-between px-5 py-4">
        <button type="button" onClick={() => setMenuOpen(true)} className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200/80 bg-white/80 text-slate-600 shadow-sm backdrop-blur-md hover:bg-white hover:text-indigo-600 active:scale-95" aria-label="Menu"><Menu size={20} /></button>
        ...
        <button type="button" onClick={openSettings} className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200/80 bg-white/80 text-slate-600 shadow-sm backdrop-blur-md hover:text-indigo-600" aria-label="Profile"><User size={20} /></button>
      </header>
      ...
      {menuOpen && <div className="fixed inset-0 z-50 bg-slate-950/20 backdrop-blur-[3px]" onClick={() => setMenuOpen(false)}><aside className="relative flex h-[100dvh] w-[84vw] max-w-[390px] flex-col border-r border-white/70 bg-gradient-to-b from-white via-sky-50/95 to-indigo-50/90 shadow-[18px_0_55px_rgba(51,65,85,0.14)] backdrop-blur-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="px-5 pb-5 pt-[calc(1.25rem+env(safe-area-inset-top))]"><div className="flex items-start justify-between"><div><span className="block bg-gradient-to-r from-sky-500 to-indigo-600 bg-clip-text text-[10px] font-extrabold uppercase tracking-[0.22em] text-transparent">PILGRIX</span><h2 className="mt-0.5 text-[22px] font-bold tracking-tight text-slate-900">Workspace</h2><p className="mt-1 text-[11px] font-medium text-slate-400">Everything for your creations</p></div><button type="button" onClick={() => setMenuOpen(false)} className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200/80 bg-white/65 text-slate-500 shadow-sm" aria-label="Close workspace"><X size={20} /></button></div></div>
        <div className="min-h-0 flex-1 overflow-hidden px-4"><div className="mb-2 px-2 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Create</div><button type="button" onClick={newCreation} className="group mb-5 flex w-full items-center justify-between rounded-2xl border border-sky-200/70 bg-gradient-to-r from-sky-400 via-blue-500 to-indigo-500 p-3.5 text-left text-white shadow-lg shadow-sky-500/15 active:scale-[0.99]"><div className="flex items-center gap-3.5"><div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/20 ring-1 ring-white/25"><Plus size={21} /></div><div><div className="text-sm font-bold">New creation</div><div className="mt-0.5 text-[10px] font-medium text-white/75">Start a new AI edit</div></div></div><ChevronRight size={18} className="text-white/75" /></button>
          <div className="mb-2 px-2 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Images</div><button type="button" onClick={openImages} className="group mb-5 flex w-full items-center justify-between rounded-2xl border border-sky-100/80 bg-gradient-to-r from-white/80 via-sky-50/70 to-indigo-50/75 px-3.5 py-3.5 text-left shadow-sm shadow-sky-300/10 active:scale-[0.99]" aria-label="Open Images"><div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-sky-100 to-indigo-100 text-indigo-500"><Images size={18} strokeWidth={1.9} /></span><div><span className="block text-sm font-semibold text-slate-700">Images</span><span className="mt-0.5 block text-[10px] font-medium text-slate-400">Create and edit visuals</span></div></div><ChevronRight size={17} className="text-slate-300 group-hover:text-indigo-500" /></button>
          <div className="mb-2 px-2 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Library</div><nav className="overflow-hidden rounded-2xl border border-white/80 bg-white/60 shadow-sm backdrop-blur-md"><button type="button" onClick={openProjects} className="group flex w-full items-center justify-between px-3.5 py-3.5 text-left hover:bg-white/80"><div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-sky-100 text-sky-600"><Folder size={18} strokeWidth={1.9} /></span><span className="text-sm font-semibold text-slate-700">Projects</span></div><ChevronRight size={17} className="text-slate-300 group-hover:text-sky-500" /></button><div className="mx-3.5 border-t border-slate-200/60" /><button type="button" onClick={openSearch} className="group flex w-full items-center justify-between px-3.5 py-3.5 text-left hover:bg-white/80"><div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-50 text-indigo-500"><Search size={18} strokeWidth={1.9} /></span><span className="text-sm font-semibold text-slate-700">Search creations</span></div><ChevronRight size={17} className="text-slate-300 group-hover:text-indigo-500" /></button></nav>
          <div className="mb-2 mt-6 px-2 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-400">Account</div><nav className="overflow-hidden rounded-2xl border border-white/80 bg-white/60 shadow-sm backdrop-blur-md"><button type="button" onClick={openSettings} className="group flex w-full items-center justify-between px-3.5 py-3.5 text-left hover:bg-white/80"><div className="flex items-center gap-3"><span className="flex h-9 w-9 items-center justify-center rounded-xl bg-slate-100 text-slate-500"><Settings size={18} strokeWidth={1.9} /></span><span className="text-sm font-semibold text-slate-700">Settings</span></div><ChevronRight size={17} className="text-slate-300 group-hover:text-slate-600" /></button></nav>
        </div><div className="px-5 pb-[calc(1.25rem+env(safe-area-inset-bottom))] pt-4"><div className="h-px bg-gradient-to-r from-transparent via-slate-200/70 to-transparent" /><p className="pt-3 text-center text-[10px] font-medium text-slate-400">Your workspace</p></div>
      </aside></div>}
    </main>
  )
}
